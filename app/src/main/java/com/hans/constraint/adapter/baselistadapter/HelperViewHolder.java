package com.hans.constraint.adapter.baselistadapter;
...
public class HelperViewHolder extends BaseViewHolder implements ViewHelper<HelperViewHolder> {
    ...
    public HelperViewHolder setImageLogoUrl(int viewId, String url, int res) {
    ...
    public HelperViewHolder setImageGlideUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        Glide.with(mContext).load(url).into(view);
        return this;
    }

    public HelperViewHolder setImageGlideCircleErrorUrl(int viewId, String url, int resId) {
        ImageView view = getView(viewId);
        if (options == null) {
    ...
    @Override
    public HelperViewHolder setBackground(int viewId, Drawable drawable) {
        View view = getView(viewId);
    ...
    public HelperViewHolder setVisible(int viewId, int vis) {
        View view = getView(viewId);
    ...
    @Override
    public HelperViewHolder setDrawableTop(int viewId, Drawable drawable) {
     ...
     * 关于事件的
     */
    public HelperViewHolder setOnClickListener(int viewId,
    ...
    public HelperViewHolder setOnCheckedChangeListener(int viewId,
